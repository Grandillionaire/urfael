...
- Frozen: a 10th attack-class with a transport probe (`npm run security`, now 11/11 classes, 108/108 checks) plus the broker (14 tests) and brokerd (9 tests) unit suites and the fuzz targets, so none of it can silently regress.
