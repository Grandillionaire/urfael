...
const COMMANDS = [
  ...
  { name: 'radar', group: 'SYSTEM', hidden: true, bareSummary: 'internal maintenance',   // OWNER-ONLY: off by default + kept out of help so a downloaded copy never surfaces it
    summary: 'watch Hermes + OpenClaw for updates of note, honestly',
