...
cd app && npm install
npm test             # 367 fast unit tests (pure modules: lib, council, personas, seal, audit-chain, registry, recall, …); no credentials, ~0.5s
...
2. `npm test` (367) and `npm run security` (10/10 · 86/86) pass, and the app still launches.
