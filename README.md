...
<img src="docs/media/demo.gif" width="820" alt="Urfael resisting the attack classes that compromised other agents: npm run security boots the real daemon and prints 11/11 attack classes, 116/116 checks passed" />

<sub><code>npm run security</code> boots the real daemon and runs the actual attack classes that owned other agents in the wild. It lands on 11/11 classes, 116/116 checks. The proof is a command you run, not a claim you read.</sub>
