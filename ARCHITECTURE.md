...
boots the real daemon and dashboard and attacks them, printing **11/11 attack classes · 118/118 checks**.
...
- **The security benchmark** (`npm run security` → `node test/security-benchmark.js`) — boots the **real**
  ...
  **11/11 attack classes · 118/118 individual checks**. Class 9, "correctness & craft regressions," guards against
